...
MAX_RECEIVE_MESSAGE_LENGTH = os.getenv('MAX_RECEIVE_MESSAGE_LENGTH', int(90 * 1024 * 1024))  # 90MB
MAX_SEND_MESSAGE_LENGTH = os.getenv('MAX_SEND_MESSAGE_LENGTH', int(90 * 1024 * 1024))  # 90MB
